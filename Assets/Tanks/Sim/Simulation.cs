...
public sealed class Simulation
{
    ...
    public void Tick(GameState state, Arena arena, ReadOnlySpan<PlayerInput> inputs)
    {
    ...
    private void UpdateTanks(GameState state, Arena arena, ReadOnlySpan<PlayerInput> inputs)
    {
        for (int i = 0; i < _config.PlayerCount; i++)
        {
            ...
            ref readonly PlayerInput input = ref inputs[i];
