...
public static class NetworkConstants
{
    ...
    public const int ApplicationDataSlotCount = 1 << 17; // The number of slots in RX and TX rings; must be at least as large as expected max session count
    public const int NetworkEventHeadroom = NetworkEventMetadata.Size; // headroom reserved for pipe events
