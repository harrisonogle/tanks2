...
public sealed class StateHistory
{
    ...
    /// <summary>
    /// Rewind the recording frontier so a rollback can re-<see cref="Record"/> from
    /// <paramref name="latestTick"/> + 1. Slots above the rewind point keep stale
    /// pre-rollback contents until the replay overwrites them in order.
    /// </summary>
