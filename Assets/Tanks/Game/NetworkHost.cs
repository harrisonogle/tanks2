...
namespace Tanks.Game
{
    ...
    /// </summary>
    public sealed class NetworkHost : MonoBehaviour
    {
        ...
        public void Initialize(int basePort, ILog log)
        {
            ...
            try
            {
                ...
                _network = new Network(transport, TanksPeerCrypto.Instance, log, AppProtocolId, AppProtocolVersion, NetworkConstants.ApplicationDataSlotCount);
            }
            catch
            {
                transport.Dispose();
