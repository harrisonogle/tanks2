...
public sealed unsafe class Pool2Tests
{
    private static BufferHandle Rent(Pool2 pool)
    {
    ...
    {
        using var pool = new Pool2(slotSize: 64, count: 4);
    ...
    {
        using var pool = new Pool2(slotSize: 64, count: 1);
    ...
    {
        using var pool = new Pool2(slotSize: 64, count: 2);
    ...
    {
        using var pool = new Pool2(slotSize: 64, count: 16);
